...
<@include('common/header', ['title' => '查找群'])
<body>
...
<script type="module">
  import {group_get_recommended, group_search, group_apply} from '/public/chat/js/api.js';
  import {getRequest, postRequest} from '/public/chat/js/request.js';
  import {addGroup} from '/public/chat/js/panel.js';
