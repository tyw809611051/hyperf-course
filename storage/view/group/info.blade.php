...
<?= $this->include('common/header', ['title' => '好友资料']) ?>
<body>
...
<script type="module">
  import {getQueryValue} from '/public/chat/js/util.js';
  import {group_info} from '/public/chat/js/api.js';
  import {getRequest} from '/public/chat/js/request.js';
